...
require_text "init/create-pg-iceberg-connection.sh" 'os.environ.get("S3_REGION_MODE") == "empty"'
...
require_text "init/create-pg-iceberg-connection.sh" "continuing with the persisted Iceberg connection"
